      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_300px] lg:items-start">
        <article className="rounded-lg border border-line bg-white p-6 shadow-sm">
          ...
          <PolicySection title="Information we collect">
            ...
            email address, shop details, and correction notes. If analytics are enabled, we may collect aggregated usage
            data such as page views, device type, browser type, and approximate location.
          </PolicySection>
          ...
          <PolicySection title="Cookies and analytics">
            The website is analytics-ready. Use privacy-friendly analytics where possible and show cookie consent where
            required. Advertising partners may use cookies or similar technologies if ads are enabled.
          </PolicySection>
